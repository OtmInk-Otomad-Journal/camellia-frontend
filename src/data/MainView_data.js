...
const data = ref({
  ...
  avatar_src: './missing.webp',
  cover_src: './missing.webp',
  light_color: '(0.6139 0.2113 26.06)',
  dark_color: '(0.36 0.2113 26.06)',
  activity: 'wc',
  reason:
    '其实只看高潮部分，我会觉得这首曲子很虚无。 伴随着地铁的轰鸣声，越过看不清的肩膀，向前，向前，但是最后只是奔向了一堆琐碎嘈杂的片段，仿佛人的血肉被这些片段组成的绞肉机磨碎，捏造成支离破碎的螺丝钉。很容易让人产生一种一切毫无意义的无力感。 但是当繁杂的声效渐渐隐去，一切又回到那个红绿灯的时候，黑白画面里的亮色反而有种单调的信念：你只需向前或等候。 就好像从同一个树根生发出来的千万个分岔枝杈最终又汇聚成一棵粗壮的树。 从生活而来，往生活而去。 向前，或等候向前。其实只看高潮部分，我会觉得这首曲子很虚无。 伴随着地铁的轰鸣声，越过看不清的肩膀，向前，向前，但是最后只是奔向了一堆琐碎嘈杂的片段，仿佛人的血肉被这些片段组成的绞肉机磨碎，捏造成支离破碎的螺丝钉。很容易让人产生一种一切毫无意义的无力感。 但是当繁杂的声效渐渐隐去，一切又回到那个红绿灯的时候，黑白画面里的亮色反而有种单调的信念：你只需向前或等候。 就好像从同一个树根生发出来的千万个分岔枝杈最终又汇聚成一棵粗壮的树。 从生活而来，往生活而去。 向前，或等候向前。其实只看高潮部分，我会觉得这首曲子很虚无。 伴随着地铁的轰鸣声，越过看不清的肩膀，向前，向前，但是最后只是奔向了一堆琐碎嘈杂的片段，仿佛人的血肉被这些片段组成的绞肉机磨碎，捏造成支离破碎的螺丝钉。很容易让人产生一种一切毫无意义的无力感。 但是当繁杂的声效渐渐隐去，一切又回到那个红绿灯的时候，黑白画面里的亮色反而有种单调的信念：你只需向前或等候。 就好像从同一个树根生发出来的千万个分岔枝杈最终又汇聚成一棵粗壮的树。 从生活而来，往生活而去。 向前，或等候向前。其实只看高潮部分，我会觉得这首曲子很虚无。 伴随着地铁的轰鸣声，越过看不清的肩膀，向前，向前，但是最后只是奔向了一堆琐碎嘈杂的片段，仿佛人的血肉被这些片段组成的绞肉机磨碎，捏造成支离破碎的螺丝钉。很容易让人产生一种一切毫无意义的无力感。 但是当繁杂的声效渐渐隐去，一切又回到那个红绿灯的时候，黑白画面里的亮色反而有种单调的信念：你只需向前或等候。 就好像从同一个树根生发出来的千万个分岔枝杈最终又汇聚成一棵粗壮的树。 从生活而来，往生活而去。 向前，或等候向前。',
  ranking: 15,
  show_staff: false,
  score_add: '合作单品 + 10%',
  more_data: [
...
function fun(obj) {
  ...
  data.value.light_color = 'oklch' + data.value.light_color
  data.value.dark_color = 'oklch' + data.value.dark_color
  ...
  if (data.value.more_data) {
    data.value.more_data.forEach((element) => {
      element.light_color = 'oklch' + element.light_color
      element.dark_color = 'oklch' + element.dark_color
